...
public class MathUtil {
	...
	// ===========================================
	// COMPLETE THE METHODS BELOW- COMPLETED
	// ===========================================
	...
	public static double[][] translationMatrix(double[] v) {
		...
		double[][] translatedMatrix = new double[][] { { 1, 0, v[0] }, { 0, 1, v[1] }, { 0, 0, 1 }, };
	...
	public static double[][] rotationMatrix(double angle) {
		...
		double angleRadians = Math.toRadians(MathUtil.normaliseAngle(angle));
		
		double sinAngle = Math.sin(angleRadians);
		double cosAngle = Math.cos(angleRadians);
		
		double[][] rotatedMatrix = new double[][]{{cosAngle, -sinAngle, 0}, {sinAngle,cosAngle,0 }, {0, 0, 1} };
	...
	public static double[][] scaleMatrix(double scale) {
		double[][] scaledMatrix = new double[][] { { scale, 0, 0 }, { 0, scale, 0 }, { 0, 0, 1 }, };
		return scaledMatrix;
	}
